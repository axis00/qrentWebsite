        ...
        <nav class="navbar bg-faded">
                <div class="navbar-collapse justify-content-md-center">
                    <ul class="navbar nav">
                        ...
                        <li class="nav-item"><a href="removed-user.jsp" class="nav-link2" id="active-item">Removed Users</a></li>
                    </ul>
                </div>
        </nav>
        ...
        <table class="table" id="users">
            ...
            <%
                ...
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT username, firstname, lastname, email, type, status FROM users WHERE type != 'Super Admin' AND status = 'disabled' ORDER BY type" );
